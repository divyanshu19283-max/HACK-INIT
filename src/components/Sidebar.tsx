...
export default function Sidebar({ current, onNavigate, onExit }: Props) {
  return (
    <aside className="flex h-full w-[280px] shrink-0 flex-col border-r border-white/5 bg-ink-900/95 shadow-2xl backdrop-blur-xl lg:w-[240px] lg:bg-ink-900/70 lg:shadow-none">
        ...
        {NAV.map((item) => {
          ...
          return (
            <button
              ...
              className={`flex min-h-11 w-full items-center gap-3 rounded-lg px-3 py-2.5 text-left text-sm transition-all ${
                active
      ...
      <div className="border-t border-white/5 px-3 py-3">
        ...
        <button onClick={onExit} className="mt-1 flex min-h-11 w-full items-center gap-3 rounded-lg px-3 py-2 text-sm text-slate-400 hover:bg-white/5 hover:text-slate-200">
